...
import com.alienator88.lockr.AdvancedConstants.ORGANIZATION_THEME_SYSTEMS
import com.alienator88.lockr.AdvancedConstants.OTHER_THEME_SYSTEMS
import com.alienator88.lockr.ThemeFunctions.checkApprovedSignature
import com.alienator88.lockr.ThemeFunctions.getSelfSignature
import com.alienator88.lockr.ThemeFunctions.getSelfVerifiedPirateTools
import com.alienator88.lockr.ThemeFunctions.isCallingPackageAllowed
...
//        val sharedPref = getPreferences(Context.MODE_PRIVATE)
    ...
    private fun showDialog() {
        ...
        val donation = view.findViewById(R.id.donate) as ImageButton
        donation.setImageResource(R.drawable.ic_paypal)
